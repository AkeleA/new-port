      ...
      <Link href="/about">
        ...
        <div>
          <p className="absolute w-[515px] h-[312px] left-0 top-[65px] font-sans not-italic font-normal text-base leading-6 text-gray-500">
            ...
            extensive expertise and attention to detail, I craft visually
            stunning and responsive websites from scratch, delivering
            exceptional user experiences. Transforming creative ideas into
            functional and elegant web solutions is my driving force. I take
            great pride in helping clients establish a strong and captivating
            online presence. By staying abreast of the latest technologies and
            frameworks, I continuously expand my knowledge and skills to create
            cutting-edge and future-proof websites.
          </p>
